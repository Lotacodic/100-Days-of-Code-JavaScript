...
for (cartBtn of cartBtns) {
    cartBtn.onclick = (e) => {
        ...
        let productCount = Number(shoppingCart.getAttribute('data-product-count')) || 0;
        ...
        let data = {
            left: shoppingCartPos.left - (shoppingCartPos.width / 2 + flyingImgPos.left + flyingImgPos.width / 2),
